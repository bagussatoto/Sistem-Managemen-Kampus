<form action="<?php echo base_url(); ?>marketing/input_aktivitas" id="target" method="post" autocomplete="off">
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Kode Aktivitas</label>
    <div class="col-sm-4 col-md-4 col-xs-12">
      <input type="text" name="kodeaktivitas" id="kodeaktivitas" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Nama Aktivitas</label>
    <div class="col-sm-8 col-md-8 col-xs-12">
      <input type="text" name="namaaktivitas" id="namaaktivitas" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Tahun Akademik</label>
    <div class="col-sm-3 col-md-3 col-xs-12">
      <input type="text" readonly name="ta_mkt" id="ta_mkt" value="<?php echo $ta; ?>" class="form-control">
    </div>
  </div>
  <div class="form-group row">
