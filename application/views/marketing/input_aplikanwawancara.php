                          ...
                          <div class="general-info">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                <form action="<?php echo base_url(); ?>marketing/insert_aplikanwawancara" id="frmaplikandaftar" method="post">
                                  ...
                                  <fieldset class="mt-4">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" value="<?php echo date('Y-m-d'); ?>" placeholder="Tanggal Wawancara" id="dropper-animation"  name="tgl_wawancara"  class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text"  placeholder="Pewawancara"  name="pewawancara"  class="form-control">
                                      </div>
                                    </div>
                                  </fieldset>
