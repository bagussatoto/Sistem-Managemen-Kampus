      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Aplikan Ujian</a></li>
          </ul>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url(); ?>marketing/editaplikanujian/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg edit"><i class="ti-pencil"></i></a>
                        <a href="<?php echo base_url(); ?>marketing/hapusaplikanujian/<?php echo $d['kode_aplikan']; ?>" class="btn btn-mini btn-danger btn-xlg hapus"><i class="ti-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
    ...
    $(function(){
      $('.hapus').on('click',function(){
          ...
          swal({
                ...
                text              : 'Dengan Menghapus Data Pendaftaran Juga Akan Menghapus Data Wawancara',
                html              : true,
