      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-block">
            <form action="<?php echo base_url(); ?>marketing/cetak_laprekapdaftar" id="frmcariaplikan" method="post" target="_blank">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8 col-md-8 col-xs-12">
                  ...
                  <button type="submit" name="all" class="btn btn-success"><i class="ti-printer"></i>  Cetak Keseluruhan</button>
                  <button type="submit" name="export" class="btn btn-success"><i class="ti-export"></i>  Export Excel</button>
                </div>
              </div>
            </form>
          </div>
