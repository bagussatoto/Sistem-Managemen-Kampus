      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Update Aplikan Daftar</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-block">
            ...
            <p>Terdapat [ <b><?php echo $totaldata; ?></b> ] Aplikan <b>Belum Daftar</b> Tahun Akademik <b><?php echo $tahun_akademik; ?></b></p>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url(); ?>marketing/inputaplikandaftar/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg edit f-12">Daftarkan</a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
