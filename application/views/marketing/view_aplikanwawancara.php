      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Aplikan Wawancara</a></li>
          </ul>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $d['pewawancara']; ?></td>
                      <td>
                        <a href="<?php echo base_url(); ?>marketing/editaplikanwawancara/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg edit"><i class="ti-pencil"></i></a>
                        <a href="<?php echo base_url(); ?>marketing/hapusaplikanwawancara/<?php echo $d['kode_aplikan']; ?>" class="btn btn-mini btn-danger btn-xlg hapus"><i class="ti-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
