                    ...
                    <div class="media-body row">
                      <div class="col-lg-12">
                        <div class="user-title">
                          ...
                          <span class="text-white"><?php echo $aplikan['asal_sekolah']; ?></span>
                        </div>
                      </div>
                      <div>
                        <div class="pull-right cover-btn">
                          <a href="<?php echo base_url(); ?>marketing/editsiswa/<?php echo $aplikan['kode_siswa']; ?>" class="btn btn-primary m-r-10 m-b-5"><i class="icofont icofont-pencil-alt-1"></i> Edit Data Siswa</a>
                          <a href="<?php echo base_url(); ?>marketing/hapussiswa/<?php echo $aplikan['kode_siswa']; ?>" class="btn btn-danger"><i class="icofont icofont-trash"></i> Hapus Data Siswa</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="tab-header card">
              <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#personal" role="tab">Data Siswa</a>
                  <div class="slide"></div>
                </li>
                <li class="nav-item">
                                  ...
                                  <table class="table m-0">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $aplikan['kelas']; ?></td>
                                      </tr>
                                      <tr>
                                        <th scope="row">Ranking</th>
                                        <td><?php echo $aplikan['ranking']; ?></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $aplikan['prestasi']; ?></td>
                                      </tr>
                                      <tr>
                                        <th scope="row">Minat</th>
                                        <td><?php echo $aplikan['minat']; ?></td>
                                      </tr>
                                      <?php if($aplikan['minat']=="LP3I"){ ?>
                                        <tr>
                                          <th scope="row">Jurusan</th>
                                          <td><?php echo $aplikan['kode_jurusan']; ?></td>
                                        </tr>
                                      <?php } ?>
                                      <tr>
                                        <th scope="row">Keterangan</th>
                                        <td><?php echo $aplikan['ket_minat']; ?></td>
                                      </tr>
                                      <tr>
                                        <th scope="row">Nama Folder</th>
                                        <td><?php echo $aplikan['namafolder']; ?></td>
                                      </tr>
                                      <tr>
                                        <th scope="row">Folder ke</th>
                                        <td><?php echo $aplikan['folder']; ?></td>
                                      </tr>
                                      <tr>
                                        <th scope="row">Pengentri</th>
                                        <td><?php echo $aplikan['operator']; ?></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
