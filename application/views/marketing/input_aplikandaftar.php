                          ...
                          <div class="general-info">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                <form action="<?php echo base_url(); ?>marketing/insert_aplikandaftar" id="frmaplikandaftar" method="post">
                                  ...
                                  <fieldset class="mt-4">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-2 col-md-2 col-xs-12">
                                        <input type="text" placeholder="Tahun" name="tahundaftar" id="tahundaftar" class="form-control">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" placeholder="Nomor Ujian" readonly value="<?php echo $nomor_ujian; ?>"  name="nomorujian" id="nomorujian" class="form-control">
                                      </div>
                                    </div>
                                  </fieldset>
                                  <fieldset class="mt-4">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" value="<?php echo $nomor_bukti; ?>"  placeholder="Nomor Bukti"  name="nomorbukti" id="nomorbukti" class="form-control">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-2 col-form-label">Biaya Pendaftaran</label>
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" onkeyup="calc()" value="<?php echo number_format($biayadaftar,'0','','.'); ?>" style="text-align:right" placeholder="Biaya Pendaftaran"  name="biayapendaftaran" id="biayapendaftaran" class="form-control">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-2 col-form-label">Diskon</label>
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" onkeyup="calc()" style="text-align:right" placeholder="Diskon"  name="diskon" id="diskon" class="form-control">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-3 col-md-3 col-xs-12">
                                        <select id="hello-single" class="form-control" name="keterangan">
                                          ...
                                          <option value="Daftar Kampus">Daftar Kampus</option>
                          								<option value="Daftar Guru BK">Daftar Guru BK</option>
                          								<option value="Daftar Online">Daftar Online</option>
                                        </select>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-2 col-form-label">Keterangan Daftar</label>
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text"   value="Lunas Pendaftaran"  name="ketdaftar"  class="form-control">
                                      </div>
                                    </div>
                                  </fieldset>
