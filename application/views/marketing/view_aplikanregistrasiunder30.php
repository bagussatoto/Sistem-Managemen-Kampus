    ...
    <div class="row align-items-end">
      <div class="col-lg-8">
        <div class="page-header-title">
          ...
          <div class="d-inline">
            <h4>Data Aplikan Sudah Registrasi < 30%</h4>
      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Aplikan Registrasi < 30%</a></li>
          </ul>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td align="right"><?php echo number_format($d['tigapuluhpersen'],'0','','.'); ?></td>
                      <td align="right"><?php echo number_format($d['realisasi'],'0','','.'); ?></td>
                    </tr>
                  <?php
                      $sno++;
                    }
