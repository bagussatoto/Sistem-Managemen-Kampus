      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Aplikan Tidak Registrasi</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          <div class="card-header">
            <h5>Aplikan Tidak Registrasi </h5>
          </div>
          <div class="card-block">
            <form action="<?php echo base_url(); ?>marketing/cetak_lapaplikantidakregis" id="frmcariaplikan" method="post" target="_blank">
