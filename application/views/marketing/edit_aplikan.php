    ...
    <div class="row align-items-end">
      <div class="col-lg-8">
        <div class="page-header-title">
          <div class="d-inline">
            <h4>Edit Data Aplikan</h4>
            <span>Edit Data Aplikan</span>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Edit Data Aplikan</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          <div class="card-header">
            <h5>Edit Data Aplikan </h5>
          </div>
          <div class="card-block">
            <form action="<?php echo base_url(); ?>marketing/update_aplikan" id="frmaplikan" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4 col-md-4 col-xs-12">
                    <select id="hello-single" class="form-control" name="sumberinformasi">
                      ...
                      <option  <?php if($aplikan['sumber_informasi']=='Presentasi'){echo "selected";} ?> value="Presentasi">Presentasi</option>
											<option  <?php if($aplikan['sumber_informasi']=='Guru BK'){echo "selected";} ?>  value="Guru BK">Guru BK</option>
											<option  <?php if($aplikan['sumber_informasi']=='Direct Mailing'){echo "selected";} ?>  value="Direct Mailing">Direct Mailing</option>
											<option  <?php if($aplikan['sumber_informasi']=='Spanduk'){echo "selected";} ?>  value="Spanduk">Spanduk</option>
											<option  <?php if($aplikan['sumber_informasi']=='Internet'){echo "selected";} ?>  value="Internet">Internet</option>
											<option  <?php if($aplikan['sumber_informasi']=='Koran'){echo "selected";} ?>  value="Koran">Koran</option>
											<option <?php if($aplikan['sumber_informasi']=='Radio'){echo "selected";} ?>  value="Radio">Radio</option>
											<option <?php if($aplikan['sumber_informasi']=='MGM'){echo "selected";} ?>  value="MGM">MGM</option>
                    	<option <?php if($aplikan['sumber_informasi']=='Facebook'){echo "selected";} ?>  value="Facebook">Facebook</option>
                    	<option <?php if($aplikan['sumber_informasi']=='Instagram'){echo "selected";} ?>  value="Instagram">Instagram</option>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-4 col-md-4 col-xs-12">
                    <select id="hello-single" class="form-control" name="sumberaplikan">
                      ...
                      <option <?php if($aplikan['sumber_aplikan']=='Datang Langsung'){echo "selected";} ?> value="Datang Langsung">Datang Langsung</option>
											<option <?php if($aplikan['sumber_aplikan']=='Didatangkan'){echo "selected";} ?> value="Didatangkan">Didatangkan</option>
											<option <?php if($aplikan['sumber_aplikan']=='Didatangi'){echo "selected";} ?>  value="Didatangi">Didatangi</option>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3 col-md-3 col-xs-12">
                    <select id="hello-single" class="form-control" name="gelombang">
                      ...
                      <option <?php if($aplikan['gelombang']=='1'){echo "selected";} ?> value="1">1</option>
											<option <?php if($aplikan['gelombang']=='2'){echo "selected";} ?> value="2">2</option>
											<option <?php if($aplikan['gelombang']=='3'){echo "selected";} ?> value="3">3</option>
											<option <?php if($aplikan['gelombang']=='4'){echo "selected";} ?> value="4">4</option>
                    </select>
                  </div>
                </div>
              </fieldset>
