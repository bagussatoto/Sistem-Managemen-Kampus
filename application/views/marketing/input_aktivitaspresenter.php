      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          <div class="card-header">
            <h5>Input Aktivitas Presenter</h5>
          </div>
          <div class="card-block">
            <form action="<?php echo base_url(); ?>marketing/insert_aktivitaspresenter" id="aktivitas_presenter" method="post" autocomplete="off">
              <div class="row">
                <div class="col-sm-12 col-lg-12">
                  <div class="input-group">
                    <input type="text" id="tanggal" class="form-control" placeholder="Tanggal" name="tanggal">
                    <input type="hidden" id="ta_mkt" name="ta_mkt" value="<?php echo $ta; ?>" class="form-control">
              ...
              <div class="row">
                <div class="col-sm-12 col-lg-12">
                  <div class="input-group">
                    <input type="text" value="<?php echo $siswa['nama_lengkap']; ?>" id="siswas" readonly name="siswa" class="form-control" placeholder="Nama Siswa">
                    <input type="hidden" value="<?php echo $siswa['kode_siswa']; ?>" id="kodesiswa" name="kodesiswa" class="form-control">
              ...
              <div class="row">
                <div class="col-sm-12 col-lg-12">
                  <div class="input-group">
                    <input type="text" readonly value="<?php echo $siswa['nama_presenter']; ?>" id="presenter" class="form-control" placeholder="Presenter">
                    <input type="hidden" value="<?php echo $siswa['kode_presenter']; ?>" id="kodepresenter" name="kodepresenter" class="form-control">
              ...
              <div class="form-group row">
                <div class="col-sm-12 col-md-12 col-xs-12">
                  <select id="hello-single" class="form-control" name="aktivitas">
                    ...
                    ?>
                      <option  value="<?php echo $t->kode_aktivitas; ?>"><?php echo $t->nama_aktivitas; ?></option>
                    <?php
                      }
                    ?>
                  </select>
              ...
              <div class="form-group row">
                <div class="col-sm-12">
                  <textarea rows="5" name="keterangan" id="keterangan" cols="5" class="form-control" placeholder="Keterangan"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 col-md-12 col-xs-12">
              ...
              <div class="form-group row">
                <div class="col-sm-12 col-md-12 col-xs-12">
                  <select id="hello-single" class="form-control" name="status">
                    ...
                    <option value="1">HOT PROSPEK</option>
										<option value="2">PROSPEK</option>
										<option value="3">BELUM PROSPEK</option>
