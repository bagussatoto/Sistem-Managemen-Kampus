      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Aplikan Datang</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-block">
            ...
            <a href="<?php echo base_url(); ?>marketing/inputaplikan" class="btn btn-sm btn-success"><i class="fa fa-user-plus"></i> Input Aplikan</a>
            <hr>
            <p>Terdapat [ <b><?php echo $totaldata; ?></b> ] Aplikan Tahun Akademik <b><?php echo $tahun_akademik; ?></b></p>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url(); ?>marketing/editaplikan/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg edit"><i class="ti-pencil"></i></a>
                        <a href="<?php echo base_url(); ?>marketing/hapusmasterpresenter/<?php echo $d['kode_aplikan']; ?>" class="btn btn-mini btn-danger btn-xlg hapus"><i class="ti-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
