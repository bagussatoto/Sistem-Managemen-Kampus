<form action="<?php echo base_url(); ?>marketing/input_target" id="target" method="post" autocomplete="off">
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Kode Target</label>
    <div class="col-sm-4 col-md-4 col-xs-12">
      <input type="text" name="kodetarget" id="kodetarget" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-3 col-form-label">Nama Target</label>
    <div class="col-sm-8 col-md-8 col-xs-12">
      <input type="text" name="namatarget" id="namatarget" class="form-control">
    </div>
  </div>
