          ...
          <div class="col-lg-12">
            ...
            <div class="tab-header card">
              <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#personal" role="tab">Proses Aplikan Ujian</a>
                  <div class="slide"></div>
                </li>
              </ul>
            </div>
              ...
              <div class="tab-pane active" id="personal" role="tabpanel">
                ...
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-header-text">Proses Aplikan Ujian</h5>
                  </div>
                          ...
                          <div class="general-info">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                <form action="<?php echo base_url(); ?>marketing/update_aplikanujian" id="frmaplikandaftar" method="post">
                                  ...
                                  <fieldset class="mt-4">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4 col-md-4 col-xs-12">
                                        <input type="text" value="<?php echo $aplikan['tgl_ujian']; ?>" placeholder="Tanggal Ujian" id="dropper-animation"  name="tgl_ujian"  class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-3 col-md-3 col-xs-12">
                                        <select id="hello-single" class="form-control" name="gelombangujian">
                                          ...
                                          <option <?php if($aplikan['gelombang_ujian']=='1'){echo "selected";} ?> value="1">1</option>
                    											<option <?php if($aplikan['gelombang_ujian']=='2'){echo "selected";} ?> value="2">2</option>
                    											<option <?php if($aplikan['gelombang_ujian']=='3'){echo "selected";} ?> value="3">3</option>
                    											<option <?php if($aplikan['gelombang_ujian']=='4'){echo "selected";} ?> value="4">4</option>
                                        </select>
                                      </div>
                                    </div>
                                  </fieldset>
    ...
    $(document).ready(function() {
      ...
      fields: {
          tgl_daftar: {
            validators: {
              notEmpty: {
                message: 'Tanggal Daftar Harus Diisi !'
              },
            }
          },
          gelombangdaftar: {
