<div class="page-wrapper">
      ...
      <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-block">
            <form action="<?php echo base_url(); ?>konfigurasi/inputuser" id="inputuser" method="post">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="#" data-kode="<?php echo $j->username; ?>" class="btn btn-mini btn-primary btn-xlg edit"><i class="ti-pencil"></i></a>
                        <a href="<?php echo base_url(); ?>konfigurasi/hapususer/<?php echo $j->username; ?>" class="btn btn-mini btn-danger btn-xlg hapus"><i class="ti-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                    $no++;
  ...
  <script type="text/javascript">
    ...
    $('.edit').on('click', function(e) {
      e.preventDefault();
      var username = $(this).attr("data-kode");
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>konfigurasi/edituser',
        data: {
          username: username
        },
        cache: false,
