                          ...
                          <div class="general-info">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                <form action="<?php echo base_url(); ?>keuangan/updaterencana2" id="formregis" method="post">
                                  ...
                                  <fieldset class="mt-4">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6">
                                      <div class="table-responsive">
                                        <table class="table table-bordered  table-sm table-styling">
                                          ...
                                          <?php
                                            ...
                                            foreach($ren as $r){
                                              if ($r->cicilanke==0){
                                					?>
                                    					<tr>
                                    						<td colspan="2"><input type="text" readonly="readonly" class="form-control" style="width:215px;" id="cicilanke<?php echo $n; ?>"  value="Registrasi"/></td>

                                    						<td align="right"><input type="text" style="text-align:right" readonly="readonly" class="form-control" style="width:150px;"  value="<?php  echo $r->wajib_bayar;?>"/></td>
                                    				...
                                    				?>
                                            <tr>
                                              <td><input type="text" readonly="readonly" class="form-control" style="width:100px;" id="cicilanke<?php echo $n; ?>"  value="<?php echo $r->cicilanke; ?>"/></td>
                                              <td><input type="text" class="form-control" readonly style="width:100px;" id="jatuhtempo<?php echo $n; ?>"  value="<?php echo $r->jatuh_tempo; ?>"/></td>
                                              <td align="right"><input type="text" readonly style="text-align:right"  class="form-control" style="width:150px;"  value="<?php  echo $r->wajib_bayar;?>"/></td>
                                            </tr>
                                          <?php
                                            }
                                            $n++;
                                          ...
                                          <tr>
                                  					...
                                  					<td align="right"><input style="text-align:right"  type="text" readonly="readonly" class="form-control"  value="<?php echo $aplikan['danapinjaman']; ?>"/></td>
                                  				</tr>
                                          <tr>
                                  					<td align="right"></td>
                                  					<td align="right">Total Rencana Bayar</td>
                                  					<td align="right"><input style="text-align:right"  type="text" readonly="readonly" class="form-control"  value="<?php echo $aplikan['harga_deal'] + $aplikan['danapinjaman']; ?>"/></td>
                                  				</tr>
                                        </table>
                                      </div>
                                    </div>
                                          ...
                                          <?php
                                            ...
                                            foreach($ren2 as $r){
                                              if ($r->cicilanke==0){
                                                ...
                                                <input type="hidden" name="jatuhtempo<?php echo $n; ?>" class="form-control" readonly style="width:100px;" id="jatuhtempo<?php echo $n; ?>"  value="<?php echo $r->jatuh_tempo; ?>"/>
                                              </tr>
                                    				<?php
                                    					}else{
                                    				?>
