      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Registrasi Mahasiswa Tingkat 4</a></li>
          </ul>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url(); ?>keuangan/inputregist4/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg edit">Registrasikan</a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
