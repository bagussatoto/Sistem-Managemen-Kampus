      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Registrasi Junior</a></li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="tab-header card">
              <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#personal" role="tab">Registrasi Mahasiswa Junior</a>
                  <div class="slide"></div>
                </li>
              </ul>
            </div>
                          ...
                          <div class="general-info">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                <?php if(!empty($biaya['kode_biaya'])){ ?>
                                  <form action="<?php echo base_url(); ?>keuangan/insert_regisjunior" id="formregis" method="post">
                                    ...
                                    <fieldset class="mt-4">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          <input type="text" value="<?php echo date('Y-m-d'); ?>" placeholder="Tanggal Registrasi" id="tglregis"  name="tglregis"  class="form-control">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          <input  value="<?php echo rand(10,1000000000); ?>" name="nim" id="nim" type="text" class="form-control" placeholder="NIM">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Harga Publish</label>
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          <input type="hidden" name="kodebiaya" value="<?php echo $biaya['kode_biaya']; ?>">
                                          <input style="text-align:right" readonly onkeyup="calc()"  value="<?php echo number_format($biaya['biaya'],'0','','.'); ?>" ame="hargapublish" id="hargapublish" type="text" class="form-control" placeholder="Harga Publish">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          <input style="text-align:right" onkeyup="calc()" value="0"  type="text" name="penyesuaian" id="penyesuaian"  class="form-control" placeholder="Penyesuaian">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Dana Pinjaman</label>
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          <input style="text-align:right" onkeyup="calc()" value="0"  type="text" name="danapinjaman" id="danapinjaman"  class="form-control" placeholder="Dana Pinjaman">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                          ...
                                          <input type="text" value="<?php echo date('Y-m-d'); ?>" name="mulaicicilan" id="mulaicicilan" class="form-control">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                              ...
                              <?php }else{ ?>
                                <div class="card bg-c-pink order-card">
                                  <div class="card-block">
                                    <h6><i class="ti-info"></i> Data Biaya Belum di Set !</h6>
                                  </div>
                                </div>
                              <?php } ?>
                              </div>
    ...
    $(function(){
      ...
      fields: {
          ...
          nim: {
            validators: {
              notEmpty: {
                message: 'NIM Harus Diisi dan Sesuai dengan E-Management!'
              },
            }
          },
      ...
      $('#tglregis').bootstrapMaterialDatePicker
      ({
        time: false,
        clearButton: true
      });
