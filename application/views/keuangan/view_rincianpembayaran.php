      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Rincian Pembayaran</a></li>
          </ul>
        </div>
      </div>
    </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url(); ?>keuangan/cetakrincianpmb/<?php echo $d['kode_aplikan']; ?>"  class="btn btn-mini btn-primary btn-xlg">Cetak Rincian</a>
                      </td>
                    </tr>
                  <?php
                      $sno++;
